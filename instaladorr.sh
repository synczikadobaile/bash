...
rm .bashrc
rm screenfetch-dev
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/.bashrc
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/screenfetch-dev
clear
...
clear
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/monitorcpu -O /bin/CpuMonitor
chmod +x /bin/CpuMonitor
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/LimpadorCache -O /bin/ClearCache
chmod +x /bin/ClearCache
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/usermonitor -O /bin/UserMonitor
chmod +x /bin/UserMonitor
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/OpenUdp -O /bin/OpenUDP
chmod +x /bin/OpenUDP
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/TesteConexao -O /bin/SpeedTest
chmod +x /bin/SpeedTest
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/Banner -O /bin/Banner
chmod +x /bin/Banner
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/UserBackup -O /bin/UserBackup
chmod +x /bin/UserBackup
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/UserCreate -O /bin/UserCreate
chmod +x /bin/UserCreate
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/UserClear -O /bin/UserClear
chmod +x /bin/UserClear
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/LimiterSSH -O /bin/LimiterSSH
...
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/MudarLimite -O /bin/MudarLimite
chmod +x /bin/MudarLimite
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/MudarSenha -O /bin/MudarSenha
chmod +x /bin/MudarSenha
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/ConfVps -O /bin/ConfVPS
chmod +x /bin/ConfVPS
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/ConfVPN -O /bin/ConfVPN
chmod +x /bin/ConfVPN
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/MudarValidade -O /bin/MudarValidade
chmod +x /bin/MudarValidade
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/VNC -O /bin/VNC
chmod +x /bin/VNC
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/UserDel -O /bin/UserDel
chmod +x /bin/UserDel
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/KernelControl -O /bin/KernelControl
chmod +x /bin/KernelControl
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/DadosMonitor -O /bin/DadosMonitor
chmod +x /bin/DadosMonitor
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/OpenVPN -O /bin/OpenVPN
chmod +x /bin/OpenVPN
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/statusvpn -O /bin/statusvpn
chmod +x /bin/statusvpn
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/restservice -O /bin/restservice
chmod +x /bin/restservice
  
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/menu -O /bin/menu
chmod +x /bin/menu
 
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/menudev -O /bin/menudev
chmod +x /bin/menudev
 
rm -rf /etc/ssh/sshd_config
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/sshd_config2 -O /etc/ssh/sshd_config
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/squidconf
chmod +x squidconf
./squidconf
wget https://raw.githubusercontent.com/synczikadobaile/bash/master/payloads -O /etc/payloads
...
tput setaf 7 ; tput setab 4 ; tput bold ; printf '%30s%s%-10s' "MENU OPENVPN E SSH VINCYHOST" ;
 
echo ""
echo ""
echo -e OBS: Digite - menu - para acessar o painel.
